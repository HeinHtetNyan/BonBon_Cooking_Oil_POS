...
class AuthService(BaseService):
    ...
    async def login(self, username: str, password: str) -> LoginResponse:
        ...
        if user is None:
            verify_password(password, "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz4TeCkw4wXJFyZ8s3QKWzXmWQpTq1u")
    ...
    async def is_token_blacklisted(self, token: str) -> bool:
        ...
        try:
            ...
            result = await redis_manager.client.get(f"blacklisted_token:{token_hash}")
